			...
			<div class="footer-call-us">
				<div class="media">
					...
					<div class="media-body">
						...
						<span class="call-us-number"><?php echo esc_html( /*rawash */ __($call_us_number,'electro') ); ?></span>
					</div>
				</div>
			</div>
	...
	function electro_footer_address() {
		...
		if ( apply_filters( 'electro_footer_address', true ) && ! empty( $footer_address  ) ) : ?>
			...
			<div class="footer-address">
				<strong class="footer-address-title"><?php echo  esc_html__( $footer_address_title, 'electro' ) /*  esc_html__( $footer_address_title ); */ ?></strong>
				<address><?php echo wp_kses_post( nl2br(/* rawash */ __($footer_address,'electro') ) ); ?></address>
			</div>
