...
if ( ! function_exists( 'electro_enqueue_styles' ) ) {
	...
	function electro_enequeue_styles() {
		...
		if ( is_rtl() ) {
			...
			wp_enqueue_style( 'electro-rtl-style', get_template_directory_uri() . '/rtl.css', '', $electro_version );
		} else {
			wp_enqueue_style( 'electro-style', get_template_directory_uri() . '/style.css', '', $electro_version );
		}
